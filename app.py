...
# Define a dummy CustomLayer if you don't need its functionality for inference,
# or import it from its module if you have its implementation elsewhere.
...
model = load_model('imdb_rnn_model.h5', custom_objects={'CustomLayer': CustomLayer})
